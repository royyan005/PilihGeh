...
$data = DB::query('SELECT * FROM votemasuk');
if(isset($_POST['terima'])){
    $data = DB::query('SELECT * FROM votemasuk');
}
if(isset($_POST['tolak'])){
    $data = DB::query('SELECT * FROM votetolak ');
}
?>
...
<head>
    ...
    <title>PilihGeh - FinalVote</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Final Vote</h1>
                    </div>
                    <form action="" method="post">
                        <button class="btn btn-sm btn-success primary shadow-sm" name='masuk'>
                            <i class="fas fa-check fa-sm text-white-50"></i> Vote Masuk
                        </button>
                        <button class="btn btn-sm btn-danger shadow-sm" name="tolak">
                            <i class="fas fa-trash fa-sm text-white-50"></i> Vote Tolak
                        </button>
                    </form>
